...
<x-layouts.admin title="App settings" heading="App settings" subheading="Sign-up, SMS, email, GIFs and calls — saved in the database, no .env editing needed.">
    <div class="admin-settings-layout">
        <nav class="admin-tabs admin-settings-nav" aria-label="Settings sections" data-settings-nav>
            <a href="#brand" class="admin-tab"><x-icon name="badge-info" /> App name &amp; icon</a>
            <a href="#signup" class="admin-tab"><x-icon name="user-plus" /> Sign-up &amp; login</a>
            ...
            <a href="#android" class="admin-tab"><x-icon name="smartphone" /> Android app</a>
            <a href="#tests" class="admin-tab"><x-icon name="send-horizontal" /> Test</a>
        </nav>
        <div class="admin-stack admin-settings-body">
            ...
            <form method="POST" action="{{ route('admin.settings.update') }}" class="admin-stack admin-settings" data-loading-form data-settings-form novalidate>
                @csrf
                @method('PUT')
                ...
                {{-- Notice --}}
                <section class="card admin-tool" id="notice">
                    <div class="card-body">
                ...
                <div class="admin-settings-save" data-settings-save>
                    <p class="admin-settings-save-text">
                        <span class="admin-settings-save-idle">Sign-up, SMS, email, GIFs, calls, legal pages and notice are saved together. Passwords and keys are stored encrypted and never shown again.</span>
                        <span class="admin-settings-save-dirty"><x-icon name="circle-alert" /> You have unsaved changes.</span>
                    </p>
                    <button type="submit" class="btn btn-primary"><x-icon name="check" /> Save settings</button>
                </div>
            </form>
