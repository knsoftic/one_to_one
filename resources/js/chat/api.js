...
export function createApi(routes) {
    ...
    return {
        ...
        profileQr: () => data(axios.get(url('profileQr'))),
        resetProfileQr: () => data(axios.post(url('profileQrReset'))),
        lookupProfileQr: (token) => data(axios.post(url('profileQrLookup'), { token })),
